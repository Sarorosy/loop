...
import { ArrowBigRightDashIcon, ChevronsRightIcon, X } from "lucide-react";
import toast from "react-hot-toast";
import { useAuth } from "../../utils/idb";

export default function AddBenchmark({ onClose, after }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`https://loopback-skci.onrender.com/api/helper/benchmark/create`, {
        method: "POST",
      ...
      setSuccessMsg("Benchmark added successfully!");
      after();
        ...
        <form className="p-4 space-y-4" o>
         ...
         active:border-blue-600"
          ...
          <div className="flex justify-end">
            ...
            >
              {loading ? "Adding..." : "Add Milestone"} <ChevronsRightIcon size={11} className="" />
            </button>
          </div>
        </form>
      </motion.div>
