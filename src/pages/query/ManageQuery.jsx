...
function ManageQuery() {
  ...
  const fetchTasks = async (
    ...
    setLoading(true);
    try {
      const res = await fetch("https://loopback-skci.onrender.com/api/query/queries", {
        method: "POST",
  ...
  const fetchDropdownData = async () => {
    try {
      const [projectsRes, usersRes] = await Promise.all([
        fetch("https://loopback-skci.onrender.com/api/query/websites"),
        fetch("https://loopback-skci.onrender.com/api/query/users"),
      ]);
