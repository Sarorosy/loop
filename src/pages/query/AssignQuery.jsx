...
const AssignQuery = ({ query, onClose }) => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch("https://loopback-skci.onrender.com/api/users/all");
  ...
  useEffect(() => {
    ...
    const fetchTeams = async () => {
      try {
        const res = await fetch("https://loopback-skci.onrender.com/api/helper/myteams", {
          method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://loopback-skci.onrender.com/api/helper/assignTask", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          user_id: user?.id,
