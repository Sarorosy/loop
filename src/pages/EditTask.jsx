...
export default function EditTask() {
  ...
  const fetchTaskDetails = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://loopback-skci.onrender.com/api/tasks/details", {
        method: "POST",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Make API call
      const response = await fetch("https://loopback-skci.onrender.com/api/tasks/update", {
        method: "POST",
        body: formDataToSend,
